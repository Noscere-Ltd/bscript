 ...
 */
export function computeOpPushTx(txOrHex, inputIndex, subscript, satoshis, codeSeparatorIndex, sigHashType = SIGHASH_ALL_FORKID) {
    ...
    if (codeSeparatorIndex !== undefined) {
        ...
        if (trimPos > subscript.length) {
            throw new Error(`computeOpPushTx: codeSeparatorIndex ${codeSeparatorIndex} is past the end of ` +
    ...
    const preimage = TransactionSignature.format({
        ...
        outputs: outputs,
        inputIndex,
        subscript: Script.fromHex(scriptCode),
...
//# sourceMappingURL=oppushtx.js.map